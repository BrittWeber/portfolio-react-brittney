...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://brittneyweber.devcamp.space/portfolio/portfolio_items",
            apiAction: 'post'
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                position: position || "",
                editMode: true,
                apiUrl: `https://brittneyweber.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
    ...
    handleSubmit(event) {
        //https://brittneyweber.devcamp.space/portfolio/portfolio_items
        axios({
